...
export class Backend implements backendInterface {
    ...
    async getCanisterAccountId(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCanisterAccountId();
    ...
    async getCompetitionState(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompetitionState();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFirstUserFlag(): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFirstUserFlag();
    ...
    async getUserChallengeSessions(): Promise<Array<ChallengeSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserChallengeSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCanisterAccountId(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCanisterAccountId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCompetitionState(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCompetitionState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
